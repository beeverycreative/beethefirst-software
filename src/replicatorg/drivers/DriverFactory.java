...
public class DriverFactory {
	...
	public static Driver factory(String driverName, Node xml) {
		if (driverName.equalsIgnoreCase("serialpassthrough")) {
			Driver driver =  loadClass("replicatorg.drivers.SerialPassthroughDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("sanguino3g")) {
			Driver driver =  loadClass("replicatorg.drivers.gen3.Sanguino3GDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("makerbot4g")) {
			Driver driver =  loadClass("replicatorg.drivers.gen3.Makerbot4GDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("makerbot4ga")) {
			Driver driver =  loadClass("replicatorg.drivers.gen3.Makerbot4GAlternateDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("reprap5d")){
			Driver driver =  loadClass("replicatorg.drivers.reprap.RepRap5DDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("simpleReprap5d")) {
			Driver driver =  loadClass("replicatorg.drivers.reprap.SimpleRepRap5DDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("null")) {
			Driver driver =  loadClass("replicatorg.drivers.NullDriver", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else if (driverName.equalsIgnoreCase("virtualprinter")) {
			Driver driver =  loadClass("replicatorg.drivers.VirtualPrinter", xml);
			driver.setDriverName(driverName);
			return driver;
		}
		else {
