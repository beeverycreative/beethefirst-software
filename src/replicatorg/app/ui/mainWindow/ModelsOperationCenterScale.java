...
//        jLabel15.setText(Languager.getTagValue(1,"", ""));    
    ...
    private void lockScale(boolean b) {
        if(b){
            b_Lock1.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Lock.png")));
            b_Lock2.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Lock.png")));
            b_Lock3.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Lock.png")));
            scaleLocked = true;
        } else {
            b_Lock1.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Unlock.png")));
            b_Lock2.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Unlock.png")));
            b_Lock3.setIcon(new ImageIcon(GraphicDesignComponents.getImage("mainWindow", "Unlock.png")));
            scaleLocked = false;
        }
    }
    ...
    private void initComponents() {
        ...
        b_Lock1 = new javax.swing.JLabel();
        b_Lock2 = new javax.swing.JLabel();
        b_Lock3 = new javax.swing.JLabel();
        ...
        b_Lock1.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        b_Lock1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/replicatorg/app/ui/panels/Unlock.png"))); // NOI18N
        b_Lock1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                b_Lock1MousePressed(evt);
            }
        });

        b_Lock2.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        b_Lock2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/replicatorg/app/ui/panels/Unlock.png"))); // NOI18N
        b_Lock2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                b_Lock2MousePressed(evt);
            }
        });

        b_Lock3.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        b_Lock3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/replicatorg/app/ui/panels/Unlock.png"))); // NOI18N
        b_Lock3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                b_Lock3MousePressed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(b_Lock1)
                            .addComponent(b_Lock2)
                            .addComponent(b_Lock3)))))
        );
...
//        Base.getMainWindow().updateModelsOperationCenter(new ModelsOperationCenterMirrorSimple());
    ...
    private void b_Lock1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_Lock1MousePressed
        if(scaleLocked) {
            lockScale(false);
        } else {
            lockScale(true);
        }
    }//GEN-LAST:event_b_Lock1MousePressed

    private void b_Lock2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_Lock2MousePressed
        if (scaleLocked) {
            lockScale(false);
        } else {
            lockScale(true);
        }
    }//GEN-LAST:event_b_Lock2MousePressed

    private void b_Lock3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_Lock3MousePressed
        if (scaleLocked) {
            lockScale(false);
        } else {
            lockScale(true);
        }
    }//GEN-LAST:event_b_Lock3MousePressed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel b_Lock1;
    private javax.swing.JLabel b_Lock2;
    private javax.swing.JLabel b_Lock3;
