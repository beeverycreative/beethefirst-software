...
public class InfoPanel extends JFrame {
	...
	public InfoPanel() {
		...
		infoArea = new JTextArea("BEESOFT:",40,60);
	...
	public String getMachineInfo() {
		...
		info += " BEE SOFT version: " + Base.VERSION_NAME + "\n";
		info += " Java version: " + System.getProperty("java.version") + "\n";
		
		info += "\n";
		info += "Machine" + "\n";
		info += " Profile Name: " + ProperDefault.get("machine.name") + "\n";
		...
		Node machineNode = MachineFactory.getMachineNode(ProperDefault.get("machine.name"));
		if (machineNode != null) {
