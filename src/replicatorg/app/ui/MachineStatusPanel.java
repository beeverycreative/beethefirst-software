...
//	static final private Color BG_BUILDING = new Color(0xff, 0xef, 0x00); // process yellow
	...
	//R2C2: Grey, grey, grey .. look like a cloudy day.
	static final private Color BG_ERROR = new Color(0xF0, 0xEF, 0xEE);
	static final private Color BG_READY = new Color(0xF0, 0xEF, 0xEE);
	static final private Color BG_BUILDING = new Color(0xF0, 0xEF, 0xEE);
