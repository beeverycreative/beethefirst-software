...
public class GraphicDesignComponents {
    ...
    private static final Color machineTextColor = getColorPref("", "#231f20");
    private static final Color buttonsTextColor = getColorPref("", "#231f20");
    private static final Color printButtonTextColor = getColorPref("", "#ffffff");
    ...
    private static Color getColorPref(String name, String defaultValue) {
