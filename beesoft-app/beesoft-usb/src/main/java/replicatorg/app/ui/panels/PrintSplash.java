...
public class PrintSplash extends BaseDialog {
    ...
    public PrintSplash(double estdTime) {
        ...
        setFont();
        centerOnScreen();
        CAMPanel canvas = (CAMPanel) Base.getMainWindow().getCanvas().clone();
        canvas.setCanvasSizePrintSplash(new Dimension(423, 331));
        canvas.getPanel().setSize(new Dimension(423, 331));
