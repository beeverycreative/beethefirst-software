...
public class SupportSwitch3 extends BaseDialog {
    ...
    private void setTextLanguage() {
        ...
        lDesc.setText("<html>"
                + Languager.getTagValue("SupportSwitch", "step4")
                + "<br>"
                + Languager.getTagValue("SupportSwitch", "step5")
                + "<br>"
                + Languager.getTagValue("SupportSwitch", "step6"));
    }
