...
*/
public class TourStep1 extends javax.swing.JFrame {
    ...
    {
        jLabel2.setText(splitString(Languager.getTagValue(1,"Tour", "Tour2")));
...
//        this.setLocationRelativeTo(Base.getMainWindow());        
    ...
    private void initComponents() {
        ...
        jPanel3.setMaximumSize(new java.awt.Dimension(183, 26));
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(36, 183));
        jPanel1.setMinimumSize(new java.awt.Dimension(36, 183));
        jPanel1.setPreferredSize(new java.awt.Dimension(36, 183));
