...
/**
 * After changing this, make sure to run it to re-generate the documentation
 * file.
 *
 * @author Ted
 *
 *
 * replicat.org claims that we support: M120, M121, M122 Snnn set the PID gain
 * for the temperature regulator M123, M124 Snnn set iMax and iMin windup guard
 * for the PID controller M129 get range M130 set range M201 get buffer size
 * M202 clear buffer M203 abort M204 pause
 */
public enum GCodeEnumeration {
    ...
    //R2C2: added M113
    M113("M", 113, "Extruder PWM: see http://reprap.org/wiki/MCodeReference"),
