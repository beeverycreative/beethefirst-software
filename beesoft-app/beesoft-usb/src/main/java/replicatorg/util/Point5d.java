...
public class Point5d {
    ...
    /**
     * Set the value of each element of this point to be the the value of the
     * respective element of p1 divided by p2: this.value[axis] = p1.value[axis]
     * / p2.value[axis].
     *
     * @param p1 numerator
    ...
    /**
     * Set the value of each element of this point to be the the value of the
     * respective element of p1 multiplied by p2: this.value[axis] =
     * p1.value[axis] * p2.value[axis].
     *
    ...
    /**
     * Round each element of the point to the nearest integer (using
     * Math.round).
     */
    public void round() {
        for (int idx = 0; idx < DIMENSIONS; idx++) {
    ...
    /**
     * Round each element of the point to the nearest integer (using
     * Math.round), storing the excess in the provided point object.
     */
