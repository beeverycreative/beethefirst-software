...
public abstract class AbstractDevice implements UsbDevice
{
    ...
    /*
     * Sets the ActiveUsbConfigurationNumber to 0 if if is not 0
     */
    public byte setActiveUsbConfigurationNumber()
    {
        if (this.activeConfigurationNumber != 1)
            this.activeConfigurationNumber = 1;
