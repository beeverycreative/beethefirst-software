...
public enum PrinterInfo {
    ...
    BEETHEFIRSTPLUS ("BEETHEFIRST_PLUS", (short) 0x29c9, (short) 0x0002, "BEEVC-BEETHEFIRST_PLUS-Firmware-"+Base.VERSION_FIRMWARE_FINAL+".BIN", "logo_beethefirst_plus.png"),
    ...
    UNKNOWN         ("UNKNOWN", (short) 0x0000, (short) 0x0000, "", "");
    ...
    PrinterInfo(String code, short vendorID, short productID, String firmwareFilename, String iconFilename) {
        this.code = code;
