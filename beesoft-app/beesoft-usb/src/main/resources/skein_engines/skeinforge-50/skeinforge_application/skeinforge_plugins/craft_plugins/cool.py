...
#BEEVC
		self.turnFanOffAtRaftBase = settings.BooleanSetting().getFromValue('Turn Fan Off during Raft Base', self, True)
...
#<BEEVC>
		...
		elif ((firstWord  == '(<raftPerimeter>)') and (self.repository.turnFanOffAtRaftBase.value==True)):
			self.distanceFeedRate.addLine('M107')
		elif ((firstWord  == '(<raftLayerEnd>') and (self.repository.turnFanOffAtRaftBase.value==True)):
			self.distanceFeedRate.addLine('M106')
#</BEEVC>
